...
describe('Tag test', () => {
    ...
    test('render unselected and active Tag component', async () => {
        ...
        render(<Tag tag={'RAP'} isSelected={false} selectTag={selectTagMock} isActive={true} />)
    ...
    test('render selected and active Tag component', async () => {
        const selectTagMock = vi.fn();
        render(<Tag tag={'RAP'} isSelected={true} selectTag={selectTagMock} isActive={true} />)
    ...
    test('render unselected and inactive Tag component', async () => {
        const selectTagMock = vi.fn();
        render(<Tag tag={'RAP'} isSelected={false} selectTag={selectTagMock} isActive={false} />)
    ...
    test('snapshot test', () => {
        const result = render(<Tag tag={'RAP'} isSelected={false} selectTag={vi.fn()} isActive={true} />)
